...
public class ImageUtil {
    ...
    public static int[] getBoundWithLength(Context context, int maxSide, Object imageObject, boolean resizeToDefault) {
        int width = -1;
        int height = -1;
        ...
        if (String.class.isInstance(imageObject)) {
            ...
            bound = BitmapDecoder.decodeBound(context.getResources(), (Integer) imageObject);
            width = bound[0];
            height = bound[1];
